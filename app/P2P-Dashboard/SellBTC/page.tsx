    ...
    <div className="min-h-screen bg-[#0d0d0d] text-white flex flex-col">
      ...
      <div className="sticky top-0 z-10 bg-[#0d0d0d] px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-lg font-semibold">Sell BTC</h1>
      ...
      <div className="px-4 flex-1 overflow-y-auto">
        ...
        <div className="bg-[#1a1a1a] rounded-xl p-4 mb-4">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2"><span className="text-white">BTC</span><span className="text-gray-500">|</span><button className="text-[#f7a600]">Max</button></div>
          </div>
          <p className="text-gray-500 text-sm mb-2">Limits: 0 - 0 BTC</p>
          <div className="flex items-center gap-1 text-gray-500 text-sm mb-3"><span>Balance: 0.00000000 BTC</span><button className="text-[#22c55e]"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" /></svg></button></div>
      ...
      <div className="px-4 py-4 bg-[#0d0d0d] border-t border-gray-800">
        <div className="flex items-center justify-between">
          <div><span className="text-2xl font-bold text-white">0</span><span className="text-white ml-1">BTC</span><p className="text-gray-500 text-sm">Total Payable</p></div>
...
export default function SellBTCPage() {
  return (<Suspense fallback={<LoadingSpinner />}><SellBTCContent /></Suspense>);
}
