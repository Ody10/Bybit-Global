...
const IdentityDashboard = () => {
  ...
  const handleVerify = () => {
    ...
    setTimeout(() => {
      ...
      window.location.href = '/app/Proof-Of-Identity/page.tsx';
    }, 2000);
  };
        ...
        <div className="mb-8">
          ...
          <div className="bg-gray-900 rounded-2xl divide-y divide-gray-800">
            <div className="flex justify-between items-center p-4">
              ...
              <span className="text-white">{showDetails ? 'John Doe' : '****'}</span>
            </div>
            <div className="flex justify-between items-center p-4">
              <span className="text-gray-400">Document ID</span>
              <span className="text-white">{showDetails ? '1234 5678 9012' : '**** **** ****'}</span>
            </div>
            <div className="flex justify-between items-center p-4">
              <span className="text-gray-400">Country/Region of Issue</span>
              <span className="text-white">{showDetails ? 'United States' : '********'}</span>
            </div>
          </div>
            ...
            {activeTab === 'standard' ? (
              <>
                <div className="flex justify-between items-center p-4">
                  ...
                  <span className="text-white">≤ 1M USDT</span>
                </div>
                <div className="flex justify-between items-center p-4">
                  <span className="text-gray-300">Daily fiat deposit</span>
                  <span className="text-white">≤ 300K USD</span>
                </div>
                <div className="flex justify-between items-center p-4">
              ...
              <>
                <div className="flex justify-between items-center p-4">
                  <span className="text-gray-300">Daily crypto withdrawal</span>
                  <span className="text-white">≤ 2M USDT</span>
                </div>
                <div className="flex justify-between items-center p-4">
                  <span className="text-gray-300">Daily fiat deposit</span>
                  <span className="text-white">≤ 400K USD</span>
                </div>
                <div className="flex justify-between items-center p-4">
                  <span className="text-gray-300">Daily fiat withdrawal</span>
                  <span className="text-white">≤ 400K USD</span>
